...
function treeAndArray() {
  ...
  document.querySelector('#visual-title').innerHTML = "Binary Tree Visualizer";
...
function heapify() {
  ...
  if (inputText.value !== '') {
    ...
    document.getElementById('visual-title').innerHTML = "Max-Heap Binary Tree Visualizer";
  }
}
...
function createBinarySearchTree() {
  ...
  if (inputText.value !== '') {
    ...
    document.querySelector('#instructions').innerHTML = "Value of Left children is always less than Parent and value of Right children is always greater than Parent";
    let tree = new Tree();
